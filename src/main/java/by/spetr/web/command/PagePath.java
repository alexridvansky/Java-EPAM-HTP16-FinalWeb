...
public class PagePath {
    ...
    public static final String SHOW_USER_LIST = "/jsp/show_user_list.jsp";
    public static final String SHOW_VEHICLE_LIST = "/jsp/show_vehicle_list.jsp";
    ...
    public static final String SHOW_VEHICLE_ADS = "/jsp/show_vehicle_ads.jsp";
    public static final String ERROR_404_PAGE = "/jsp/error_404.jsp";
    public static final String ERROR_PAGE = "/jsp/error.jsp";
    public static final String INDEX_PAGE = "index.jsp";
    public static final String MAIN_PAGE = "/jsp/main.jsp";
    public static final String LOGIN_ERROR = "/jsp/sign_in_error.jsp";
    public static final String UNSUPPORTED_COMMAND = "/jsp/error/command_error.jsp";
