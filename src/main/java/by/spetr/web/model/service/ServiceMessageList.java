...
public class ServiceMessageList {
    ...
    public static final String PASSWORD_INVALID = "Password doesn't match requirements";
    public static final String EMAIL_INVALID = "E-Mail doesn't match requirements";
