...
CREATE TABLE `user_confirmation` (
  `user_confirmation_id` bigint NOT NULL AUTO_INCREMENT,
  `confirmation` varchar(30) NOT NULL,
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`user_confirmation_id`),
  UNIQUE KEY `user_id_UNIQUE` (`user_id`),
  UNIQUE KEY `user_confirmation_id_UNIQUE` (`user_confirmation_id`),
  CONSTRAINT `user_id_frkey` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
...
-- Dump completed on 2021-08-24 16:23:54
